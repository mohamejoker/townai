          ...
          <TabsContent value="create" className="space-y-4">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          setDesignRequest((prev) => ({
                            ...prev,
                            type: type.value as DesignRequest["type"],
                          }))
                        }
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setDesignRequest((prev) => ({
                      ...prev,
                      platform: value as DesignRequest["platform"],
                    }))
                  }
                >
                  <SelectTrigger>
                ...
                {styles.map((style) => (
                  <Badge
                    ...
                    onClick={() =>
                      setDesignRequest((prev) => ({
                        ...prev,
                        style: style.value as DesignRequest["style"],
                      }))
                    }
                  >
                    {style.label}
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                ...
                <span>
                  {isGenerating ? "جاري الإنشاء..." : "إنشاء التصميم"}
                </span>
              </Button>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setBrandInfo((prev) => ({ ...prev, name: e.target.value }))
                  }
                />
              </div>
